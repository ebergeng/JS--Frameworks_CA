    ...
    return (
        <ContactFormContainer onSubmit={handleSubmit}>
            <ContactInfoWrapper>
                ...
                <ContactInfoBody>
                    <label htmlFor="name">Full Name* <ErrorMsg>{errors.fullName}</ErrorMsg></label>
                    <input type="text" name="fullName" id="name" value={form.fullName} onChange={handleChange}/>  

                    <label htmlFor="subject">Subject* <ErrorMsg>{errors.subject}</ErrorMsg> </label>
                    <input type="text" name="subject" id="subject" value={form.subject} onChange={handleChange}/>  

                    <label htmlFor="email">Email* <ErrorMsg>{errors.email}</ErrorMsg> </label>
